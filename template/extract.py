...
def run():
    ...
    # source = etl_db.Db2()    # IF SOURCE IS DB2-DATABASE
    source = etl_csv.Csv()   # IF SOURCE IS CSV-FILE
    # source = etl_json.Json() # IF SOURCE IS JSON-FILE
    # source = etl_fix.Fix()   # IF SOURCE IS FIXLENGTH
